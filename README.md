...
> Install the CLI with the script below and take the desktop app from [Releases](https://github.com/GQAdonis/librefang/releases).

#### CLI, daemon, and web dashboard

```bash
curl -fsSL https://raw.githubusercontent.com/GQAdonis/librefang/main/web/public/install.sh | sh
```
