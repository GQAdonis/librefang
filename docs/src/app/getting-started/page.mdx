...
<Note>
BossFang does not publish an apt repository — `packaging/` ships an Arch repository and AUR recipes only.
...
BossFang provides 32 agent types from the [registry](https://github.com/librefang/librefang-registry/tree/main/agents) (assistant pre-installed, others available from dashboard). Spawn the assistant agent:
