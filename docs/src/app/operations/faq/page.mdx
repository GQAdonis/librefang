...
Frequently asked questions about BossFang.

---

## Installation and Configuration

### Q: How to install BossFang?
...
BossFang requires API keys from at least one LLM provider:
...
BossFang supports 44 channel adapters:
...
### Q: How does BossFang protect my data?

BossFang uses 16-layer security protection:
...
### Q: Does BossFang charge?

BossFang itself is open source and free. You only pay for LLM provider API fees.
...
### Q: How is BossFang different from other frameworks?

| Feature | BossFang | OpenClaw | LangChain |
|---------|-----------|----------|-----------|
