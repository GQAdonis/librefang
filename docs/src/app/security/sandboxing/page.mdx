...
| **Service management** | Stopping or disabling system services, and bouncing the shared BossFang daemon | `systemctl stop`, `systemctl disable`, `librefang stop`, `librefang gateway restart` |
