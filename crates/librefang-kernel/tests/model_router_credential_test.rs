...
// `#[serial]` for the same reason the two tests above carry it: this one boots
// a kernel that reads the environment, and `catalog_defined_env_name_allows_routing`
// calls `set_var` from another harness thread (#7781 review).
#[serial_test::serial]
#[test]
